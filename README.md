...
## Example
- **Potential Investment**: Say you're considering an investment of $100,000 that will last 15 periods with cash flows of $12,000 per period that will grow at 10% per period. The next best option may be a risk-free interest rate of 5%. When this is plotted using the program created, we see the investment will outperform the risk-free rate over the 15 periods. The NPV = $134345.85
